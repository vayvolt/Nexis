...
<head>
    ...
    <title><?php echo $e(($t ?? static fn (string $k): string => $k)('admin.login.title')) ?></title>
    ...
    <style>
        ...
        input { width: 100%; padding: .5rem .6rem; border: 1px solid #d6d3d1; border-radius: 6px; font: inherit; box-sizing: border-box; }
...
<div class="login-wrap">
    <nav class="lang-switch" aria-label="<?php echo $e($t('admin.login.lang_nav')) ?>">
        <a href="<?php echo $e($bp) ?>/admin/login?lang=de"<?php echo $currentLang === 'de' ? ' aria-current="true"' : '' ?>>Deutsch</a>
        <a href="<?php echo $e($bp) ?>/admin/login?lang=en"<?php echo $currentLang === 'en' ? ' aria-current="true"' : '' ?>>English</a>
    </nav>
...
<form method="post" action="<?php echo $e($basePath) ?>/admin/login">
    ...
    <button type="submit"><?php echo $e($t('admin.login.submit')) ?></button>
</form>
<p class="login-foot">
    <a href="<?php echo $e($basePath) ?>/account/login"><?php echo $e($t('admin.login.customer')) ?></a>
